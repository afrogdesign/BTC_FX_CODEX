...
def _manual_delivery_current_app_ohlcv_source_coverage_summary_data(
    *,
    ...
    return {
        ...
        "freshness_note": "candidate/OHLCV inputs unavailable; report-only fallback summary",
...
def _manual_delivery_current_app_ohlcv_source_coverage_summary_rows(
    ...
    return [
        ...
        ("candidate_timestamp_min", ohlcv_source_coverage_summary.get("candidate_timestamp_min")),
        ("candidate_timestamp_max", ohlcv_source_coverage_summary.get("candidate_timestamp_max")),
        ("candidate_max_after_ohlcv_end_hours", ohlcv_source_coverage_summary.get("candidate_max_after_ohlcv_end_hours")),
        ("stale_threshold_hours", ohlcv_source_coverage_summary.get("stale_threshold_hours")),
        ("ohlcv_range_freshness_status", ohlcv_source_coverage_summary.get("ohlcv_range_freshness_status")),
        ("freshness_note", ohlcv_source_coverage_summary.get("freshness_note")),
...
def _manual_delivery_current_app_integration_contract_markdown(
    *,
    ...
    lines = [
        ...
        f"- candidate_timestamp_min: {ohlcv.get('candidate_timestamp_min', '')}",
        f"- candidate_timestamp_max: {ohlcv.get('candidate_timestamp_max', '')}",
        f"- candidate_max_after_ohlcv_end_hours: {ohlcv.get('candidate_max_after_ohlcv_end_hours', 0.0)}",
        f"- stale_threshold_hours: {ohlcv.get('stale_threshold_hours', 24.0)}",
        f"- ohlcv_range_freshness_status: {ohlcv.get('ohlcv_range_freshness_status', 'no_candidate_timestamps')}",
        f"- freshness_note: {ohlcv.get('freshness_note', 'candidate/OHLCV inputs unavailable; report-only fallback summary')}",
