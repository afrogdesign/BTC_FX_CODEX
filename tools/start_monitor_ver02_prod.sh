...
PLIST_SRC="$BASE_DIR/deploy/com.afrog.btc-monitor-ver02.plist"
PLIST_DEST="$HOME/Library/LaunchAgents/com.afrog.btc-monitor-ver02.plist"
LABEL="com.afrog.btc-monitor-ver02"
