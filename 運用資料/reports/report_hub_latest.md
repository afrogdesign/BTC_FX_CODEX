...
- generated_at: 2026-05-30 03:20 JST
...
### daily-sync 日次
- latest: [運用資料/reports/feedback_daily_sync_20260530.md](運用資料/reports/feedback_daily_sync_20260530.md)
- previous: [運用資料/reports/feedback_daily_sync_20260529.md](運用資料/reports/feedback_daily_sync_20260529.md)
- storage: `active`
- purpose: 日次の全体成績、AI事後評価、Phase1 状況の入口。
- last_date: `2026-05-30` / freshness: `fresh(0d)`
...
- last_date: `2026-05-26` / freshness: `stale(4d)`
...
### 紙候補診断
- latest: [運用資料/reports/analysis/paper_opportunity_diagnostics_20260526.md](運用資料/reports/analysis/paper_opportunity_diagnostics_20260526.md)
- previous: [運用資料/reports/archive/analysis/paper_opportunity_diagnostics_20260525.md](運用資料/reports/archive/analysis/paper_opportunity_diagnostics_20260525.md)
- storage: `active`
...
- last_date: `2026-05-14` / freshness: `stale(16d)`
...
- last_date: `2026-03-30` / freshness: `stale(61d)`
