...
- 候補件数: 48件
- prelabel: SWEEP_WAIT=31件, RISKY_ENTRY=16件, NO_TRADE_CANDIDATE=1件
- setup reason: confidence_below_min=48件
- phase1 reasons: confidence_below_min=48件, no_trade_candidate=1件
- risk_flags: lower_liquidity_close=48件, sweep_incomplete=48件, short_cover_risk=19件, cvd_bearish_divergence=8件, long_into_major_resistance=5件
- 平均 execution=18.7 / 平均 wait=83.7
...
- 20260503_130500: 2026-05-03 22:05 / prelabel=SWEEP_WAIT / setup=confidence_below_min / execution=19.0 / wait=81.6
