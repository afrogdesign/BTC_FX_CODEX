...
- 候補件数: 50件
- prelabel: SWEEP_WAIT=32件, RISKY_ENTRY=16件, NO_TRADE_CANDIDATE=2件
- setup reason: confidence_below_min=50件
- phase1 reasons: confidence_below_min=50件, no_trade_candidate=2件
- risk_flags: lower_liquidity_close=50件, sweep_incomplete=50件, short_cover_risk=21件, cvd_bearish_divergence=9件, long_into_major_resistance=7件
- 平均 execution=18.3 / 平均 wait=84.2
