...
- market_map candidate before/after guard: 273件 -> 117件
- market_map candidate before/after hard guard: 273件 -> 117件
- closed sl_hit: 216件 / quality guard 該当 closed sl_hit: 12件
...
- sl_too_tight_review_risk: triggered / sl_eval=too_tight 14件
- entry_delay_review_risk: triggered / too_early or tf_15m_eval=poor 15件
