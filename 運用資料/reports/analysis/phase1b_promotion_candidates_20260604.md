...
- 勝率=0.0% / TP1先行=0.0% / 近似PF=0.00
- 平均 direction=59.8 / 平均 execution=23.0 / 平均 wait=75.2
- 平均MFE=0.00 / 平均MAE=0.00

## Phase 1B-lite
- 条件: confidence_watch_learning + SWEEP_WAIT 限定。正式 trade_execution_gate は緩めない
- lite 候補件数: 5件
- 勝率=0.0% / TP1先行=0.0% / 近似PF=0.00
- 平均 direction=60.2 / 平均 execution=23.2 / 平均 wait=74.9
- 扱い: 実弾ではなく、正式 Phase 1B でもない。専用CSVでのみ追跡する
