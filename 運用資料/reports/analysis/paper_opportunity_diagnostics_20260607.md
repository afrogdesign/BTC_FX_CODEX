...
- 対象 paper_positions: 386件
- フィルタ: date_from=2026-04-18
- フィルタ: date_to=2026-06-07
- closed: 376件 / opportunity_type: setup_watch_learning=253件, market_map_opportunity=117件, confidence_watch_sweep_lite=5件, formal_execution_candidate=1件
- closed 全体: 勝率=8.5% / 平均R=0.51 / 簡易PF=2.58 / 終了=missed_opportunity=166件, sl_hit=145件, tp2_hit=32件, timeout=22件, entry_not_reached=11件
- market_map_opportunity: 117件 / 勝率=9.4% / 平均R=0.37 / 簡易PF=2.05 / 終了=sl_hit=56件, missed_opportunity=42件, tp2_hit=11件, timeout=8件
- その他 opportunity: 259件 / 勝率=8.1% / 平均R=0.57 / 簡易PF=2.86
...
- quality guard blocked: 517件 / 理由=require_execution_for_high_wait+suppress_long_high_wait=305件, require_execution_for_high_wait=184件, require_execution_for_high_wait+suppress_long_high_wait+suppress_trend_flip_up_strong=28件
- hard_quality_blocked: 517件 / 理由=require_execution_for_high_wait+suppress_long_high_wait=305件, require_execution_for_high_wait=184件, require_execution_for_high_wait+suppress_long_high_wait+suppress_trend_flip_up_strong=28件
- soft_quality_risk: 14件 / 理由=soft_risk:suppress_long_high_wait=12件, soft_risk:suppress_trend_flip_up_strong=2件
- market_map candidate before/after guard: 363件 -> 117件
- market_map candidate before/after hard guard: 363件 -> 117件
- closed sl_hit: 145件 / quality guard 該当 closed sl_hit: 16件
