...
- 2026-05-18 JST
  ...
  - `フェーズ別計画_Phase0-1.md` は現行サマリに置き換えられたため `計画/archive/superseded/2026-05-18/` へ移動した。
  - `現行計画サマリ_20260518.md` を新設し、現在地、実装済み計画、まだ進行中の判断、次に作るべきものを 1 枚に圧縮した。
  - `計画/README.md`、`Phase1条件の見方.md`、`マイルストーン定義.md`、`開発ロードマップ.md`、`NEXT_TASK.md` の参照を新構成へ更新した。

- 2026-05-18 JST
  - `運用資料/運用/` を整理し、日常入口には `ルール/` 2本、`実務/運用コマンドメモ.md`、`実務/評価シート更新_AI手順.md` だけを残す構成にした。
  - 実装済み・過去版前提になった `ログ検証と改善運用ガイド.md`、`通知共通層_notification_contextメモ.md`、`採点調整シート.md` は `運用/archive/2026-05-18_実装済みメモ/` へ移動した。
  - `運用/README.md` と `ルール/今後の運用ルール.md` を `Ver02.5-v7` / `Phase 1B-lite` 基準へ更新した。
