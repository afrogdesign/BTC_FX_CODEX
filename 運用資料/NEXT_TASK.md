...
- `Ver02.5-v8` は紙ポジション状態遷移、TP2 / SL / timeout / missed_opportunity / entry_not_reached、日次レポートの closed 成績集計を追加する版。全体テスト 177 件 OK。
- 常駐 `com.afrog.btc-monitor` は `Ver02.5-v8` 反映後に再起動済み。PID `9798`、`state=running`、`monitor.err` は空。
