...
- Active Plan candidate outcomes: `運用資料/reports/analysis/active_plan_candidate_outcomes_20260608.md`
- `active_plan_candidate_outcomes` builder / CLI は `BTCFX-20260608-045` で正本化済み。候補行はまだ 0 件のため、次は候補発生後に outcome report を再生成する。
