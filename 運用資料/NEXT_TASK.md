...
## 次のタスク
1. `tmp/backtest/comparison_summary.csv` の結果を前提に、より長い取得区間や別期間で差分が出るか再確認する。
2. Ver02.3 のコミット単位を整理して commit / push する。
3. その後に本番観測系の優先タスクへ戻り、CLI/API フォールバック確認とレビュー反映を続ける。
