...
- current_work_id: `BTCFX-20260702-POST-EVAL-APP-READY-GATE-CONTRACT`
- mode: `NORMAL_CODEX`

## Current goal

Compact post-eval recommendation status の ready-gate contract validation を report-only で固める。
...
Stop with `BLOCKED BTCFX-20260702-POST-EVAL-APP-READY-GATE-CONTRACT: <one specific question>` if:
...
- `BTCFX-20260702-POST-EVAL-SURFACE-DOCS-SYNC`
