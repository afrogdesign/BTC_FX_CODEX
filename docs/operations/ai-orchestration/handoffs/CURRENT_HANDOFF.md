...
- AI orchestration anchor files are being introduced.
...
| BTCFX-20260608-048 | planned | pending | Add AI orchestration anchors |

## Next prompt for Codex

```text
NEXT BTCFX-20260608-049
Goal: Sync NEXT_TASK.md and CONTROL.md after AI orchestration anchors are added.
Read: 運用資料/NEXT_TASK.md, docs/operations/ai-orchestration/CONTROL.md, docs/operations/ai-orchestration/TASK_LEDGER.md
