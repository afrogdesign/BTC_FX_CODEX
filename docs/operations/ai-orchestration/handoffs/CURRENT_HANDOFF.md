...
- `docs/operations/manual-preview/ACTIVE_PLAN_MANUAL_PREVIEW_RUNBOOK.md` captures the concise manual-preview workflow.
- `CONTROL.md` now records the reviewed manual-preview operating package baseline and defers the next step to STOP: choose the next product step from the reviewed manual-preview operating package baseline.
