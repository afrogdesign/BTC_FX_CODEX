...
WP0は現行sourceのcontract owner・version・consumer・authorityを整理した。WP1はactual evidenceが既に存在する現行truthをcanonical docsへ反映し、旧blockerを履歴として残した。source、test、gate、threshold、classifier、notification、runtimeは変更していない。
