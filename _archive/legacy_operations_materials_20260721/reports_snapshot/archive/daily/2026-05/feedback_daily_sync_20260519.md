...
## 1. まず結論
- 今回の完了データは 46 件です。近似PF は 0.88、全体勝率は 56.5% でした。
- 事後評価では「待つ判断に使えた」が最も多く、16 件でした。
- 平均の役立ち度は 3.52 / 5 でした。
- 根拠整合の入力率は 39.1%、整合した比率は 100.0% でした。
...
## 2. 今回の対象
- 集計期間: 2026-05-12 22:05 〜 2026-05-18 13:05
- 総観測件数: 46
- データ品質の内訳: ok=46
- 近似PF: 0.88
...
- ready阻害理由: confidence_below_min=32件, entry_zone_not_reached=11件, near_entry_zone_waiting_trigger=2件, inside_entry_zone_with_trigger=1件
...
- 根拠整合の入力率: 39.1% / 整合率: 100.0%
- SL評価: SL が狭すぎた=6件, SL は妥当=17件
- TP評価: TP は妥当=13件, TP が近すぎた=4件, TP が遠すぎた=6件
- 4時間足評価: 妥当=9件, 一部弱い=14件
- 1時間足評価: 一部弱い=17件, 妥当=3件, 弱い=3件
- 15分足評価: 弱い=8件, 妥当=7件, 一部弱い=8件
### 改善アクション
- 分類: 入口条件を調整=19件, 観測継続=3件, 通知文面を調整=1件
- 重要度: 高=8件, 中=14件, 低=1件
- 高優先の代表例:
...
### AI事後評価 health
- 状態: backlogあり
- 候補件数: eligible=311 / backlog=76 / AI済み=235 / human_override=0
...
- range: 勝率=59.1%, 平均MFE=7.53, 平均MAE=6.83 (n=22) / データ不足 22/30
- transition: 勝率=54.2%, 平均MFE=5.28, 平均MAE=7.62 (n=24) / データ不足 24/30

### signal_tier別件数・勝率・平均MFE・平均MAE
- normal: 勝率=56.5%, 平均MFE=6.36, 平均MAE=7.25 (n=46)

### prelabel別件数・勝率・平均MFE・平均MAE
- ENTRY_OK: 勝率=50.0%, 平均MFE=7.25, 平均MAE=5.65 (n=4) / データ不足 4/30
- RISKY_ENTRY: 勝率=60.0%, 平均MFE=4.93, 平均MAE=8.35 (n=10) / データ不足 10/30
- SWEEP_WAIT: 勝率=61.1%, 平均MFE=6.69, 平均MAE=7.62 (n=18) / データ不足 18/30
- NO_TRADE_CANDIDATE: 勝率=50.0%, 平均MFE=6.70, 平均MAE=6.43 (n=14) / データ不足 14/30

### bias別件数・勝率
- long: 勝率=36.8% (n=19) / データ不足 19/30
- short: 勝率=70.4% (n=27) / データ不足 27/30

### bias別 direction 正誤
- long: correct=6, wrong=8, unclear=5 / wrong_rate=42.1% (n=19)
- short: correct=14, wrong=10, unclear=3 / wrong_rate=37.0% (n=27)

### 成績指標
- 全体勝率: 56.5%
- 平均MFE(signal_based): 6.36
- 平均MAE(signal_based): 7.25
...
- lower_liquidity_close: wrong_rate=46.7% (wrong=7/15)
- major_support_rejection: wrong_rate=46.7% (wrong=7/15)
- sweep_incomplete: wrong_rate=44.4% (wrong=16/36)
...
- direction_execution_conflict の主な risk_flags: bid_wall_close=1件, cvd_bullish_divergence=1件, orderbook_bid_heavy=1件
- suppress_reason の内訳: confidence_below_short_min=5件, bias_wait=2件, multiple_no_trade_flags=2件
- ENTRY_OK + invalid: 0件
...
- phase1_observation_gate=blocked: 39件
- 観測タイプ: setup_watch_learning=7件
- 観測候補全体: 7件 / 勝率=57.1% / TP1先行=57.1% / 近似PF=0.52 / 平均MFE=4.96 / 平均MAE=9.56
- setup_watch_learning: 7件 / 勝率=57.1% / TP1先行=57.1% / 近似PF=0.52 / 平均MFE=4.96 / 平均MAE=9.56
- 代表例: 20260517_010500, 20260514_160500, 20260514_080500, 20260513_163400, 20260513_120500
- 主な観測ブロック理由: confidence_below_min=32件, no_trade_candidate=14件, watch_conditions_not_met=1件
...
### market_map
- 記録あり: 42件
- primary_state: confirmed_down=16件, early_down=10件, confirmed_up=8件, early_up=6件, near_major_support=1件
- flags: short_into_major_support=35件, long_into_major_resistance=32件, support_to_resistance_flip=24件, support_to_resistance_retest_confirmed=24件, trend_flip_confirmed_down=16件, major_support_rejection=15件, major_resistance_rejection=14件, resistance_to_support_flip=14件
- trend_state: confirmed_down=16件, early_down=10件, confirmed_up=8件, early_up=6件
- 下方向反転系: 26件 / 勝率=65.4% / wrong_rate=38.5%
- 下方向反転系 平均MFE24h=8.63 / 平均MAE24h=5.57
- 代表例: 20260518_000500, 20260517_140501, 20260517_110500, 20260517_050500, 20260517_010500
- 扱い: レジサポ実体、役割転換、失敗ブレイクの新判定を後追い検証する

### 紙トレード準備
- trade_execution_gate=pass: 0件
- trade_execution_gate=blocked: 46件
- 主なブロック理由: phase1_inactive=46件, setup_not_ready=46件, execution_shadow_too_low=24件, wait_pressure_too_high=23件, no_trade_flags_present=1件
- paper_orders planned: 0件
- phase1_v1_shadow 記録付き: 46件
- opportunity_gate=pass: 20件
- paper_positions 記録: 20件
- 紙ポジション状態: closed=20件
- 紙ポジション終了状態: missed_opportunity=10件, sl_hit=9件, tp2_hit=1件
- 紙実行候補タイプ: market_map_opportunity=13件, setup_watch_learning=7件
- opportunity_type 別 closed:
  - market_map_opportunity: 13件 / 勝率=7.7% / 平均R=0.50 / 簡易PF=2.30
  - setup_watch_learning: 7件 / 勝率=0.0% / 平均R=0.13 / 簡易PF=1.30
- missed_opportunity: 10件
- missed代表例: 20260518_000500, 20260517_140501, 20260517_010500
- 24h超の pending: 0件
...
- lower_liquidity_close: negative_rate=86.7% (n=15)
- sweep_incomplete: negative_rate=83.3% (n=36)
...
- short_into_major_support: negative_rate=71.4% (n=35)
- major_resistance_rejection: negative_rate=71.4% (n=14)
- support_to_resistance_retest_confirmed: negative_rate=70.8% (n=24)
- support_to_resistance_flip: negative_rate=70.8% (n=24)
- orderbook_ask_heavy: negative_rate=70.0% (n=10)
- upper_liquidity_close: negative_rate=66.7% (n=21)
