...
- 対象 paper_positions: 267件
- フィルタ: date_from=2026-04-18
- フィルタ: date_to=2026-05-26
- closed: 266件 / opportunity_type: setup_watch_learning=162件, market_map_opportunity=98件, confidence_watch_sweep_lite=5件, formal_execution_candidate=1件
- closed 全体: 勝率=7.5% / 平均R=0.33 / 簡易PF=1.85 / 終了=sl_hit=121件, missed_opportunity=100件, tp2_hit=20件, timeout=14件, entry_not_reached=11件
- market_map_opportunity: 98件 / 勝率=10.2% / 平均R=0.37 / 簡易PF=2.01 / 終了=sl_hit=48件, missed_opportunity=35件, tp2_hit=10件, timeout=5件
- その他 opportunity: 168件 / 勝率=6.0% / 平均R=0.31 / 簡易PF=1.76
...
- missed_opportunity: 35件 / 勝率=0.0% / 平均R=1.30 / 簡易PF=0.00 / 終了=missed_opportunity=35件

## confidence 帯別
- direction<60: 27件 / 勝率=3.7% / 平均R=0.11 / 簡易PF=1.21 / 終了=sl_hit=14件, missed_opportunity=11件, tp2_hit=1件, timeout=1件
- direction>=60: 71件 / 勝率=12.7% / 平均R=0.47 / 簡易PF=2.52 / 終了=sl_hit=34件, missed_opportunity=24件, tp2_hit=9件, timeout=4件
- execution<24: 66件 / 勝率=9.1% / 平均R=0.10 / 簡易PF=1.22 / 終了=sl_hit=40件, missed_opportunity=15件, tp2_hit=6件, timeout=5件
- execution>=24: 32件 / 勝率=12.5% / 平均R=0.93 / 簡易PF=5.93 / 終了=missed_opportunity=20件, sl_hit=8件, tp2_hit=4件
- wait>=60: 39件 / 勝率=12.8% / 平均R=-0.16 / 簡易PF=0.74 / 終了=sl_hit=28件, tp2_hit=5件, missed_opportunity=5件, timeout=1件
- wait<60: 59件 / 勝率=8.5% / 平均R=0.72 / 簡易PF=4.87 / 終了=missed_opportunity=30件, sl_hit=20件, tp2_hit=5件, timeout=4件

## wait 帯別
- wait<40: 1件 / 勝率=0.0% / 平均R=1.30 / 簡易PF=0.00 / 終了=missed_opportunity=1件
- 40<=wait<60: 58件 / 勝率=8.6% / 平均R=0.71 / 簡易PF=4.75 / 終了=missed_opportunity=29件, sl_hit=20件, tp2_hit=5件, timeout=4件
...
- 20<=execution<35: 50件 / 勝率=14.0% / 平均R=0.64 / 簡易PF=3.13 / 終了=missed_opportunity=23件, sl_hit=19件, tp2_hit=7件, timeout=1件
- 35<=execution<50: 4件 / 勝率=0.0% / 平均R=1.30 / 簡易PF=0.00 / 終了=missed_opportunity=4件

## setup reason 別
- confidence_below_min: 79件 / 勝率=8.9% / 平均R=0.36 / 簡易PF=1.95 / 終了=sl_hit=38件, missed_opportunity=31件, tp2_hit=7件, timeout=3件
...
- short: 80件 / 勝率=11.2% / 平均R=0.57 / 簡易PF=2.97 / 終了=missed_opportunity=34件, sl_hit=33件, tp2_hit=9件, timeout=4件

## market_map flag 別
- short_into_major_support: 87件 / 勝率=9.2% / 平均R=0.28 / 簡易PF=1.72 / 終了=sl_hit=46件, missed_opportunity=28件, tp2_hit=8件, timeout=5件
- support_to_resistance_flip: 70件 / 勝率=11.4% / 平均R=0.63 / 簡易PF=3.34 / 終了=missed_opportunity=32件, sl_hit=26件, tp2_hit=8件, timeout=4件
- support_to_resistance_retest_confirmed: 70件 / 勝率=11.4% / 平均R=0.63 / 簡易PF=3.34 / 終了=missed_opportunity=32件, sl_hit=26件, tp2_hit=8件, timeout=4件
- long_into_major_resistance: 68件 / 勝率=10.3% / 平均R=0.12 / 簡易PF=1.27 / 終了=sl_hit=42件, missed_opportunity=15件, tp2_hit=7件, timeout=4件
- trend_flip_confirmed_down: 48件 / 勝率=12.5% / 平均R=0.60 / 簡易PF=3.05 / 終了=missed_opportunity=20件, sl_hit=19件, tp2_hit=6件, timeout=3件
- major_resistance_rejection: 40件 / 勝率=12.5% / 平均R=0.10 / 簡易PF=1.22 / 終了=sl_hit=25件, missed_opportunity=8件, tp2_hit=5件, timeout=2件
- trend_flip_early_down: 35件 / 勝率=8.6% / 平均R=0.30 / 簡易PF=1.74 / 終了=sl_hit=18件, missed_opportunity=13件, tp2_hit=3件, timeout=1件
- failed_breakout_down_reversal: 28件 / 勝率=14.3% / 平均R=0.05 / 簡易PF=1.11 / 終了=sl_hit=18件, missed_opportunity=4件, tp2_hit=4件, timeout=2件
...
- market_map:support_to_resistance_flip: 70件 / 勝率=11.4% / 平均R=0.63 / 簡易PF=3.34 / 終了=missed_opportunity=32件, sl_hit=26件, tp2_hit=8件, timeout=4件
- market_map:failed_breakout_down_reversal: 28件 / 勝率=14.3% / 平均R=0.05 / 簡易PF=1.11 / 終了=sl_hit=18件, missed_opportunity=4件, tp2_hit=4件, timeout=2件
...
- delay_entry_on_sweep_wait: SWEEP_WAIT の弱い終了が 60件あるため、即 entry ではなく再確認待ちへ寄せる候補。
...
## 不足データ
- MFE/MAE 判定: `mfe_atr` が 98件で欠落
- MFE/MAE 判定: `mae_atr` が 98件で欠落
- RR 判定: `rr_estimate` が 98件で欠落
