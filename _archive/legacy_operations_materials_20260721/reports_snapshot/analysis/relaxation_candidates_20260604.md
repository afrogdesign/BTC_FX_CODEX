...
- 候補件数: 53件
- prelabel: SWEEP_WAIT=33件, RISKY_ENTRY=18件, NO_TRADE_CANDIDATE=2件
- setup reason: confidence_below_min=53件
- phase1 reasons: confidence_below_min=53件, no_trade_candidate=2件
- risk_flags: lower_liquidity_close=53件, sweep_incomplete=53件, short_cover_risk=21件, short_into_major_support=9件, long_into_major_resistance=9件
- 平均 execution=18.4 / 平均 wait=83.9

## 候補一覧
- 20260530_230500: 2026-05-31 08:05 / prelabel=RISKY_ENTRY / setup=confidence_below_min / execution=19.0 / wait=81.6
- 20260527_160500: 2026-05-28 01:05 / prelabel=RISKY_ENTRY / setup=confidence_below_min / execution=29.0 / wait=73.6
