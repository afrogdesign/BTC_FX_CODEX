...
def _dedup_policy_episodes(episodes: list[dict[str, Any]], policy: str, separation: timedelta = timedelta(hours=3)) -> list[dict[str, Any]]:
    """One deterministic unresolved episode per policy/context within 3 hours."""
