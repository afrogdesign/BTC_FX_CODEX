...
class P8CliTests(unittest.TestCase):
    def test_missing_input_exit_two_no_traceback(self):
        ...
        args += ["--output-root","/tmp/no","--runtime-generation","r","--source-head","h","--cutoff-utc","2026-07-25T00:00:00Z","--stdout-json"]
