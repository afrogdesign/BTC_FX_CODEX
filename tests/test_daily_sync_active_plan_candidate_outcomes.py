...
class DailySyncActivePlanCandidateOutcomesTests(unittest.TestCase):
    def test_daily_sync_builds_active_plan_candidate_outcomes(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                ...
                patch(
                    "tools.log_feedback.build_active_plan_candidate_outcomes",
                    return_value=candidate_outcomes_path,
                ) as outcomes_mock,
        ...
        outcomes_mock.assert_called_once_with(
            base_dir=base_dir,
