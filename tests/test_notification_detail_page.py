...
class NotificationDetailPageTests(unittest.TestCase):
    def test_build_notification_detail_html_contains_explanations_and_escapes_text(self) -> None:
        ...
        self.assertIn("<details class=\"section internal-diagnostics\">", html)
        self.assertNotIn("Ver04-v1 手動確認サポート", html)
        ...
        self.assertIn("value-defense-band-long", html)
        self.assertIn("value-defense-band-short", html)
        self.assertIn("invalidation-band-long", html)
        self.assertIn("invalidation-band-short", html)
        self.assertIn("value-defense-trigger-long", html)
        self.assertIn("value-defense-trigger-short", html)
        self.assertIn("price-map-separator", html)
        self.assertIn("Value Defense", html)
        self.assertIn("value-defense-dashboard", html)
        ...
        self.assertIn("主情報", html)
        self.assertIn("補助情報", html)
        self.assertIn("value-defense-row-chip long shallow", html)
        self.assertIn("value-defense-row-chip short defense", html)
        ...
        self.assertIn("ロング/ショートの傾き", html)
        self.assertIn("入る条件の確認", html)
        self.assertIn("無効化・待機理由", html)
        self.assertIn("価格帯の確認", html)
        self.assertIn("見る順番", html)
        self.assertIn("安全境界", html)
        self.assertNotIn("Market regime", html)
        self.assertNotIn("Phase", html)
        self.assertNotIn("4h / 1h / 15m", html)
        self.assertNotIn("Score balance", html)
        self.assertNotIn("Entry / execution context", html)
        self.assertNotIn("Reversal / invalidation context", html)
        self.assertNotIn("Price context", html)
        self.assertNotIn("Operator note", html)
        self.assertIn("このブロックは検証と運用確認用です。売買判断の主導線には置きません。", html)
        self.assertIn("通知メールと公開HTMLは同じ判断ソースから出しますが、ここは内部確認だけに使います。", html)
        self.assertIn("local dashboard / app surface / runtime contract / manual delivery reference をまとめて確認します。", html)
        self.assertIn("report-only / not FORMAL_GO / no automatic order / human decides manually", html)
        ...
        self.assertIn("15分足", html)
        self.assertIn("スコア差", html)
        self.assertIn("大転換候補", html)
        self.assertIn("ダマシ注意", html)
        self.assertIn("決め打ちしません", html)
        ...
        self.assertIn("行動種別", html)
        self.assertIn("入る条件", html)
        self.assertIn("利確 / 損切り", html)
        self.assertIn("無効化 / 待機理由", html)
        self.assertIn("有効期限", html)
        self.assertIn("安全境界", html)
        self.assertNotIn("Entry mode", html)
        self.assertNotIn("Entry condition", html)
        self.assertNotIn("TP / SL", html)
        self.assertNotIn("Invalidation / wait", html)
        self.assertNotIn("Timeout / validity", html)
        ...
        self.assertIn("行動種別", attention_html)
        self.assertIn("安全境界", attention_html)
        self.assertNotIn("Entry mode", attention_html)
        self.assertIn("内部確認・検証情報", attention_html)
        self.assertIn("<details class=\"section internal-diagnostics\">", attention_html)
        self.assertNotIn("Ver04-v1 手動確認サポート", attention_html)
        ...
        self.assertIn("report-only / not FORMAL_GO / no automatic order / human decides manually", attention_html)
        self.assertIn("大転換チャンス確認", attention_html)
        self.assertIn("4時間足", attention_html)
        self.assertIn("1時間足", attention_html)
        self.assertIn("15分足", attention_html)
        self.assertIn("スコア差", attention_html)
        self.assertIn("大転換候補", attention_html)
        self.assertIn("ダマシ注意", attention_html)
        self.assertIn("決め打ちしません", attention_html)
